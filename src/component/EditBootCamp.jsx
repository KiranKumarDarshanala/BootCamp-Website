      ...
      <section className="w-full min-h-screen p-4">
        ...
        <div className="w-full pl-[200px]">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-2xl font-bold"> Update BootCamp</h1>

          </div>
          <form
            onSubmit={handleSubmit}
            className="w-full bg-white/35 backdrop-blur-md rounded-xl p-6 shadow-lg"
          >
            <h1 className='font-bold'>Bootcamp Information</h1>
            <p className='text-gray-600'>Provide basic information about your bootcamp to help students understand what they'll learn.</p><br />
            <label htmlFor="name" className='font-bold'>Bootcamp Title *</label>
            <input
              className="w-full border p-3 mt-1 mb-4 rounded-xl"
              type="text"
              name="name"
              id="name"
              required
            ...
            <input
              className="w-full border mt-1 p-3 mb-4 rounded-xl"
              type="email"
              name="email"
              id="email"
              required
            ...
            <textarea
              className="w-full border mt-1 p-3 mb-4 rounded-xl resize-none"
              name="description"
              value={description}
              required
            ...
            <input
              className="w-full border mt-1 p-3 mb-6 rounded-xl"
              type="url"
              name="photo"
              id="photo"
              value={photo}
            ...
            <div className='flex justify-between'>
              <Link to="/layout" className='border flex items-center pl-3 pr-3 font-bold rounded border-gray-400 hover:bg-blue-100 hover:text-blue-400 transition-all'>Cancel</Link>
              <button
                type="submit"
